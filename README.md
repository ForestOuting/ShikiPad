...
Column order: `Up`, `Down`, `Left`, `Right`, `Square/X`, `Triangle/Y`, `Cross/A`, `Circle/B`.

| Layer | Up | Down | Left | Right | Square/X | Triangle/Y | Cross/A | Circle/B |
|---|---|---|---|---|---|---|---|---|
| Base | Up arrow | Down arrow | Left arrow | Right arrow | Space | Backspace | Enter | Tab |
| R1 / RB | i | t | o | n | e | a | h | u |
| L1 / LB | s | c | l | r | d | g | y | z |
| R2 / RT | m | f | q | w | j | x | p | b |
| L2 / LT | k | 4 | 3 | v | 1 | 2 | 5 | 6 |
| R1 + L1 | 7 | = | - | 8 | 9 | 0 | , | . |
| L2 + R2 | ( / full-width ( | ) / full-width ) | : / full-width : | - / em dash / _ | " / curly quotes | ' / curly quotes | [ / full-width [ / { | ] / full-width ] / } |
| L1 + R2 | backtick / middle dot / ~ / full-width ~ | # | * | / | @ | ? / full-width ? | ! / full-width ! | ; / full-width ; |
| L2 + R1 | backslash / \| / ideographic comma | % | + | $ | yuan sign | & | ^ | ... / ellipsis |

ShikiPad sends physical key strokes. Variants in the same cell depend on left-stick `Shift` and the active input method punctuation mode. For example, `yuan sign` shares the physical key used by `$`, and ellipsis shares the physical key used by `^`.
